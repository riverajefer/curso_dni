...
<div class="row">
	<div class="col-md-6 col-md-offset-3">
		<h1 class="text-warning">Página 4</h1>
		<hr>
	<p>
		...
		<ul class="pager">
			@if($id_page!=1)
		  		<li class="previous"><a href="{{URL::to('amarillo/pagina/'.$anterior)}}" >&larr; Anterior</a></li>
			@endif
			   <li class="next"><a href="{{URL::to('amarillo/pagina/'.$siguiente)}}" >Siguiente &rarr;</a></li>
		</ul>
